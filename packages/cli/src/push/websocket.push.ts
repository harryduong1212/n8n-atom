...
@Service()
export class WebSocketPush extends AbstractPush<ExtendedWebSocket> {
	add(pushRef: string, userId: User['id'], connection: ExtendedWebSocket) {
	...
	protected close(connection: ExtendedWebSocket): void {
		connection.close();
	}
	...
	protected ping(connection: ExtendedWebSocket): void {
